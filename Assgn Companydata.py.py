...
data=pd.read_csv("C:/Users/NAVEEN REDDY/Downloads/Company_Data.csv")
data.head()
list(data)
data.shape
data.dtypes
...
DT.tree_.max_depth
'''
conclusion: For random state 91, and for the max depth of 8 in decision tree we are achieving 
