...
# as we working on the model we take two csv train and test in train and test data have some categorical so we use label encoding
...
''' conclusion:
    As per given data set we have to find train and test accuracy so here the accuracy is rbf is good 80% '''
